<!-- Header-area start -->
<header class="header-area header-3" data-aos="fade-down">
    <!-- Start mobile menu -->
        ...
        <div class="container">
            ...
            <div class="logo">
                <a href="index.html" target="_self" title="Treats">
                    <img class="lazyload" src="assets/images/placeholder.png" data-src="assets/images/logo/logo-1.png"
                        alt="Treats logo">
                </a>
            </div>
            <!-- Menu toggle button -->
            ...
            <div class="container">
                <div
                    ...
                    <div class="social-link icon-only">
                        ...
                        <a class="rounded-pill" href="https://www.dribbble.com/" target="_blank" title="dribbble"><i
                                class="fab fa-dribbble"></i></a>
                        <a class="rounded-pill" href="https://www.twitter.com/" target="_blank" title="twitter"><i
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="more-option mobile-item">
                        ...
                        <div class="item">
                            <a href="reservation.html" class="btn btn-md btn-primary radius-sm" title="Book a Table"
